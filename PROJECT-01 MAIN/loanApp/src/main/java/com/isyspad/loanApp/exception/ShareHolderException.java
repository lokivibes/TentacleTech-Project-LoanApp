...
public class ShareHolderException {
    ...
    @ExceptionHandler
    public ResponseEntity<String> error(NullPointerException r) {
        return new ResponseEntity<String>("Value cannot be null", HttpStatus.BAD_REQUEST);
    }
}
